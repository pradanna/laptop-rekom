        ...
        <div class="sidebar ">
            ...
            <div class="menu-container">
                ...
                <ul>
                    ...
                    <li>
                        <a class="menu tooltip {{ Request::is('admin/item') ? 'active' : '' }}" href="/admin/item">
                            <span class="material-symbols-outlined">laptop_mac</span>
                            <span class="text-menu">Laptop</span>
                            <span class="tooltiptext">Laptop</span>
                        </a>
                    </li>


                    <li>
                        <a class="menu tooltip {{ Request::is('admin/transactions') ? 'active' : '' }}"
                    ...
                    <li>
                        <a class="menu tooltip {{ Request::is('admin/member') ? 'active' : '' }}" href="/admin/member">
